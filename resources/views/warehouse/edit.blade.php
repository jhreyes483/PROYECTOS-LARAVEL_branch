...
@section('content')
    <form action="{{ route('warehouses.update', $warehouse->IdWareHouse) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-xl-12">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row gy-2 gx-3 align-items-center">
                            <div class="col-sm-auto">
                                ...
                                <input type="text" value="{{ $warehouse->ReferenceWareHouse }}" class="form-control" id="reference" name="ReferenceWareHouse" placeholder="referencia" autocomplete="off" MAXLENGTH="10" required>
                            </div>
                            <div class="col-sm-auto">
                                <label class="form-label" for="Name">Nombre *</label>
                                <input type="text" value="{{ $warehouse->Name }}" class="form-control" id="Name" name="Name" placeholder="Nombre bodega" autocomplete="off" MAXLENGTH="50" required>
                            </div>
                            <div class="col-sm-auto">
                            ...
                            <div class="col-sm-auto">
                                ...
                                <a class="btn btn-warning w-md" href="{{ route('warehouses.index') }}">Cancelar</a>
                            </div>
                        </div>
                    </div>
                    <!-- end card body -->
